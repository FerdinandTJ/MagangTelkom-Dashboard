                ...
                {summary ? (
                    <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mb-6">
                        ...
                        <div className="bg-white dark:bg-gray-900 rounded-lg border border-gray-200 dark:border-gray-800 p-5 shadow-sm">
                            ...
                            <p className="text-2xl font-bold text-gray-900 dark:text-gray-100">{summary.total_companies || 0}</p>
                            <p className="text-xs text-gray-500 dark:text-gray-500 mt-1">Total customer count</p>
                        </div>
                        ...
                        <div className="bg-white dark:bg-gray-900 rounded-lg border border-gray-200 dark:border-gray-800 p-5 shadow-sm">
                            ...
                            <p className="text-2xl font-bold text-gray-900 dark:text-gray-100">{periodText}</p>
                            <p className="text-xs text-gray-500 dark:text-gray-500 mt-1">Reporting timeframe</p>
                        </div>
                    </div>
                ) : (
